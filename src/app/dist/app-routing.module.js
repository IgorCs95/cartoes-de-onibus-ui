...
var routes = [
    {
        path: "usuarios",
        component: crud_usuarios_component_1.CrudUsuariosComponent
    },
    {
        path: "usuarios/create",
        component: criar_usuario_component_1.CriarUsuarioComponent
    },
    {
        path: "cartoes",
        component: crud_cartoes_component_1.CrudCartoesComponent
    },
    {
        path: "cartoes/create",
        component: criar_cartoes_component_1.CriarCartoesComponent
    },
    {
